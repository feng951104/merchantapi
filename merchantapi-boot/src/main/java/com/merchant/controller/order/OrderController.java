...
import com.merchant.vo.order.data.MdljPrinter;
...
public class OrderController extends BaseController {
    ...
    public CommonResultVO sendPostTest(HttpServletRequest request, HttpServletResponse response,  MdljPrinter mdljPrinter){
        CommonResultVO commonResultVO=new CommonResultVO();

        log.info(mdljPrinter.toString());
